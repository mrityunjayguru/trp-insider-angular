...
@Component({
  selector: 'app-admin-approval-rejection',
  templateUrl: './admin-approval-rejection.component.html',
  styleUrls: ['./admin-approval-rejection.component.css']
})
export class AdminApprovalRejectionComponent {
  vdata:any;
  Vendorusers:any;
  apiService: any;
...
genPdf(imgurl:any,qrfile:any, designnumber:any)
{
   ...
   this.logService.clog(imgurl + " "+ qrfile +  designnumber,true);
