...
@Component({
  selector: 'app-vendor-user-scanproduct',
  templateUrl: './vendor-user-scanproduct.component.html',
  styleUrls: ['./vendor-user-scanproduct.component.css']
})


export class VendorUserScanproductComponent implements AfterViewInit {
