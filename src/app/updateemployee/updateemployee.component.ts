  ...
  this.logService = logService;
    ...
    this.router = router;
     ...
     .subscribe((params:any) => {
      ...
      this.apiService.getemployeebyid(params.id).subscribe(
        (response : any) => {
        ...
        console.log(" this.Employee Data ");
             ...
             this.logService.clog(params.id, true )
             this.logService.clog("Product Data",this.productdata, true )

             
             this.readFile(this.imgConfig+"/"+this.productdata.topimage,0);
      ...
      (response : any) => {               
        ...
        console.log("alldesignation");
             ...
             this.productsForm = this.formBuilder.group({
              ...
              topimage:[this.readFile(this.imgConfig+"/"+this.productdata.topimage,0)],
              name:[this.productdata.name],
              designation:[this.productdata.designation],
              department:[this.productdata.department],
              workmode:[this.productdata.workmode],
              officelocation:[this.productdata.officelocation],
              contactnumber:[this.productdata.contactnumber],
              address:[this.productdata.address],
              country:[this.productdata.country],
              state:[this.productdata.state],
              city:[this.productdata.city],
              pincode:[this.productdata.pincode],
              reportingmanager:[this.productdata.reportingmanager],
              gender:[this.productdata.gender],
            
              dateofbirth: [new Date(Number(this.productdata.dateofbirth)).toISOString().slice(0, 10)],
              dateofjoining:[new Date(Number(this.productdata.dateofjoining)).toISOString().slice(0, 10)],
            
              pannumber:[this.productdata.pannumber],
              uan:[this.productdata.uan],
              aadhaarnumber:[this.productdata.aadhaarnumber],
              pfnumber:[this.productdata.pfnumber],
              pfjoiningdate:[new Date(Number(this.productdata.pfjoiningdate)).toISOString().slice(0, 10)],
              esinumber:[this.productdata.esinumber],
              nameofbank:[this.productdata.nameofbank],
              ifsccode:[this.productdata.ifsccode],
              accountnumber:[this.productdata.accountnumber],
              nameofaccountholder:[this.productdata.nameofaccountholder],
              upiid:[this.productdata.upiid],
              bloodgroupofemployee:[this.productdata.bloodgroupofemployee],
              emergencycontactpersonname:[this.productdata.emergencycontactpersonname],
              relation:[this.productdata.relation],
              relationcontactnumber:[this.productdata.relationcontactnumber],
              typeofemployment:[this.productdata.typeofemployment],
              monthlyfixedsalary:[this.productdata.monthlyfixedsalary],
              minimumguaranteedsalary:[this.productdata.minimumguaranteedsalary],
              monthlytargetvalue:[this.productdata.monthlytargetvalue],
              commissiontype:[this.productdata.commissiontype],
              commissionrate:[this.productdata.commissionrate],

               designationid:[this.productdata.designationid],
               department_id:[this.productdata.departmentobj.id],
               workmodeid:[this.productdata.workmodeid],
               typeofemploymentid:[this.productdata.typeofemploymentid],
               commissionid:[this.productdata.commissionid],
               staeid:[this.productdata.staeid],

              imgfile0:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile0,1)],
              imgfile1:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile1,2)],
              imgfile2:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile2,3)],
              imgfile3:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile3,4)],
              imgfile4:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile4,5)],
              imgfile5:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile5,6)],
              imgfile6:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile6,7)],
              imgfile7:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile7,8)],
              imgfile8:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile8,9)],
              imgfile9:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile9,10)],
              imgfile10:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile10,11)],
              imgfile11:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile11,12)],
              imgfile12:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile12,13)],
              imgfile13:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile13,14)],
              imgfile14:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile14,15)],
              imgfile15:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile15,16)],
              imgfile16:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile16,17)],
              imgfile17:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile17,18)],
              imgfile18:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile18,19)],
              imgfile19:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile19,20)],
              imgfile20:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile20,21)],
              imgfile21:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile21,22)],
              imgfile22:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile22,23)],
              imgfile23:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile23,24)],
              imgfile24:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile24,25)],
              imgfile25:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile25,26)],
              imgfile26:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile26,27)],
              imgfile27:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile27,28)],
              imgfile28:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile28,29)],
              imgfile29:[this.readFile(this.imgConfig+"/"+this.productdata.imgfile29,30)],
              imgfile30:[''],
       ...
       //  get sizes
        this.apiService.getAllSize().subscribe( 
          (response: any) => {
               this.sizes = response.data;
              this.logService.clog(this.sizes, true)
...
onSubmit()
{
    ...
    if(this.productsForm.value.designnumber.length == 0 ) 
    {
      alert("Kinldy enter the desig number ");
      return ;
    }
       else if( this.productsForm.value.size.length == 0 )
    {
      alert("Kinldy enter  the size ");
      return ;
    }
    else if( this.productsForm.value.vendorname.length == 0 )
    {
      alert("Kinldy enter  the vendor name ");
      return ;
    }

    else if( this.productsForm.value.category.length == 0  )
    {
      alert("Kinldy enter  the category");
      return ;
    }
    else if( this.productsForm.value.wsp.length == 0 || this.productsForm.value.wsp == 0  )
    {
      alert("Kinldy enter  the wsp");
      return ;
    }
    else if( this.productsForm.value.setofpic.length == 0 ||  this.productsForm.value.setofpic == 0 )
    {
      alert("Kinldy select  the set of peice");
      return ;
    }
    else
    {
...
const payload = {
  ...
  this.apiService.updateemployeebyid(this.formData).subscribe(
      (response : any) => {
...
onFileSelectBottom (event:any):void { 
 ...
 // this.formData.append('file', this.docPictureinput,this.docPictureinput.name);
  ...
  readFile(url:any, index:any) {

    this.http.get(url, { responseType: 'blob' })
      .subscribe((blob:any) => {

        this.imageData[index]= blob;
        const reader = new FileReader();
        ...
        reader.onload = (event: any) => {
                ...
                else if(index==1)
                {
                  ...
                  this.imageSrcbottom = event.target.result;
                  this.setBackgroundImage(this.imageSrcbottom);
                ...
                else if(index==2)
                {
                  ...
                  this.imageSrcbottom1 = event.target.result;
                  this.setBackgroundImage1(this.imageSrcbottom1);
                ...
                else if(index==3)
                {
                  ...
                  this.imageSrcbottom2 = event.target.result;
                  this.setBackgroundImage2(this.imageSrcbottom2);
                ...
                else if(index==4)
                {
                  ...
                  this.imageSrcbottom3 = event.target.result;
                  this.setBackgroundImage3(this.imageSrcbottom3);
                ...
                else if(index==5)
                {
                  ...
                  this.imageSrcbottom4 = event.target.result;
                  this.setBackgroundImage4(this.imageSrcbottom4);
                ...
                else if(index == 6)
                {
                  ...
                  this.imageSrcbottom5 = event.target.result;
                  this.setBackgroundImage5(this.imageSrcbottom5);
                ...
                else if(index == 7)
                {
                  ...
                  this.imageSrcbottom6 = event.target.result;
                  this.setBackgroundImage6(this.imageSrcbottom6);
                ...
                else if(index == 8)
                {
                  ...
                  this.imageSrcbottom7 = event.target.result;
                  this.setBackgroundImage7(this.imageSrcbottom7);
                ...
                else if(index == 9)
                {
                  ...
                  this.imageSrcbottom8 = event.target.result;
                  this.setBackgroundImage8(this.imageSrcbottom8);
                ...
                else if(index == 10)
                {
                  ...
                  this.imageSrcbottom9 = event.target.result;
                  this.setBackgroundImage9(this.imageSrcbottom9);
                ...
                else if(index == 11)
                {
                  ...
                  this.imageSrcbottom10 = event.target.result;
                  this.setBackgroundImage10(this.imageSrcbottom10);
                ...
                else if(index == 12)
                {
                  ...
                  this.imageSrcbottom11 = event.target.result;
                  this.setBackgroundImage11(this.imageSrcbottom11);
                ...
                else if(index == 13)
                {
                  ...
                  this.imageSrcbottom12 = event.target.result;
                  this.setBackgroundImage12(this.imageSrcbottom12);
                ...
                else if(index == 14)
                {
                  ...
                  this.imageSrcbottom13 = event.target.result;
                  this.setBackgroundImage13(this.imageSrcbottom13);
                ...
                else if(index == 15)
                {
                  ...
                  this.imageSrcbottom14 = event.target.result;
                  this.setBackgroundImage14(this.imageSrcbottom14);
                ...
                else if(index == 16)
                {
                  ...
                  this.imageSrcbottom15 = event.target.result;
                  this.setBackgroundImage15(this.imageSrcbottom15);
                ...
                else if(index == 17)
                {
                  ...
                  this.imageSrcbottom16 = event.target.result;
                  this.setBackgroundImage16(this.imageSrcbottom16);
                ...
                else if(index == 18)
                {
                  ...
                  this.imageSrcbottom17 = event.target.result;
                  this.setBackgroundImage17(this.imageSrcbottom17);
                ...
                else if(index == 19)
                {
                  ...
                  this.imageSrcbottom18 = event.target.result;
                  this.setBackgroundImage18(this.imageSrcbottom18);
                ...
                else if(index == 20)
                {
                  ...
                  this.imageSrcbottom19 = event.target.result;
                  this.setBackgroundImage19(this.imageSrcbottom19);
                ...
                else if(index == 21)
                {
                  ...
                  this.imageSrcbottom20 = event.target.result;
                  this.setBackgroundImage20(this.imageSrcbottom20);
                ...
                else if(index == 22)
                {
                  ...
                  this.imageSrcbottom21 = event.target.result;
                  this.setBackgroundImage21(this.imageSrcbottom21);
                ...
                else if(index == 23)
                {
                  ...
                  this.imageSrcbottom22 = event.target.result;
                  this.setBackgroundImage22(this.imageSrcbottom22);
                ...
                else if(index == 24)
                {
                  ...
                  this.imageSrcbottom23 = event.target.result;
                  this.setBackgroundImage23(this.imageSrcbottom23);
                ...
                else if(index == 25)
                {
                  ...
                  this.imageSrcbottom24 = event.target.result;
                  this.setBackgroundImage24(this.imageSrcbottom24);
                ...
                else if(index == 26)
                {
                  ...
                  this.imageSrcbottom25 = event.target.result;
                  this.setBackgroundImage25(this.imageSrcbottom25);
                ...
                else if(index == 27)
                {
                  ...
                  this.imageSrcbottom26 = event.target.result;
                  this.setBackgroundImage26(this.imageSrcbottom26);
                ...
                else if(index == 28)
                {
                  ...
                  this.imageSrcbottom27 = event.target.result;
                  this.setBackgroundImage27(this.imageSrcbottom27);
                ...
                else if(index == 29)
                {
                  ...
                  this.imageSrcbottom28 = event.target.result;
                  this.setBackgroundImage28(this.imageSrcbottom28);
                ...
                else if(index == 30)
                {
                  ...
                  this.imageSrcbottom29 = event.target.result;
                  this.setBackgroundImage29(this.imageSrcbottom29);
