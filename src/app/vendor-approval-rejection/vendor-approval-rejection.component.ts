...
@Component({
  selector: 'app-vendor-approval-rejection',
  templateUrl: './vendor-approval-rejection.component.html',
  styleUrls: ['./vendor-approval-rejection.component.css']
})
export class VendorApprovalRejectionComponent {
...
genPdf(imgurl:any,qrfile:any, designnumber:any)
{
   ...
   console.log(imgurl + " "+ qrfile +  designnumber);
