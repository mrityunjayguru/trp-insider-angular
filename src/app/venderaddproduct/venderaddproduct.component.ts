...
@Component({
  selector: 'app-venderaddproduct',
  templateUrl: './venderaddproduct.component.html',
  styleUrls: ['./venderaddproduct.component.css']
})



export class VenderaddproductComponent {
  vdata: any;
  Vendorusers: any;
  mainfoot: any;
  docTopimage: any;
  ...
  constructor(formBuilder: FormBuilder, apiService: ApiService, router: Router) {
    ...
    if (this.Vendorusers != undefined) {
      if (this.Vendorusers.roleid === "02" && this.Vendorusers.firstName.length > 0) {
        //alert(" valid Vendor ")
      }
      else {
