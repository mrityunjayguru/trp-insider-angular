...
@Component({
  selector: 'app-merchantuserinvoice',
  templateUrl: './merchantuserinvoice.component.html',
  styleUrls: ['./merchantuserinvoice.component.css']
})

export class MerchantuserinvoiceComponent implements OnInit {
  apiService: any;
