...
@Component({
  selector: 'app-merchantvieworders',
  templateUrl: './merchantvieworders.component.html',
  styleUrls: ['./merchantvieworders.component.css']
})
export class MerchantviewordersComponent implements OnInit{
  ...
  closeItems() {
    ...
    constructor(logService : LogService, headerFooterService :HeaderfooterService,
                      ...
                      this.apiService. getAllOrdersByUserdesignnumber(params.designnumber).subscribe(
                        (response:any) => {
                          ...
                          console.log("==============response===========");
                              ...
                              this.logService.clog(this.orderData, false)
...
getUserByMobile(mobile:any)
{
  ...
  {
    this.logService.clog("==========================Blank=====================", true)
      return "-------------";
  }
