...
@Component({
  selector: 'app-venderupdateproduct',
  templateUrl: './venderupdateproduct.component.html',
  styleUrls: ['./venderupdateproduct.component.css']
})


export class VenderupdateproductComponent {
  vdata:any;
  Vendorusers:any;
  mainfoot:any;
  ...
  constructor(imgConfigService: ImgconfigService,formBuilder:FormBuilder,apiService:ApiService, router :Router, route:ActivatedRoute, http:HttpClient){
    ...
    if(this.Vendorusers != undefined)
    {
      
    }
    else
    {
          alert(" seesion has been expired : Login Again ");
          return;
    }
    ...
    this.router = router;
     ...
     this.productsForm = this.formBuilder.group({
        ...
        wsp:[0.0],
        description:[''],
        vendorname:[this.Vendorusers.firstName],
        imgfile0:[''],
        imgfile1:[''],
        imgfile2:[''],
        imgfile3:[''],
        ...
        imgcolor30:[''],
         ...
         vendorid:[this.Vendorusers.id],
         roleid:[this.Vendorusers.roleid],
         vendormobile:[this.Vendorusers.mobile],
...
onSubmit()
{
    ...
    {
        console.log(" Update Vendor looking all Good ");   
    }
    ...
    this.apiService.updateproductbyid(this.formData).subscribe(
      (response : any) => {
            ...
            if(response.mesage == "Data Stored successfully." || response.status == 200)
            {
                ...
                this.router.navigateByUrl('/vendorproducts.component');
            }
      })
}
