...
@Component({
  selector: 'app-merchantproductsedit',
  templateUrl: './merchantproductsedit.component.html',
  styleUrls: ['./merchantproductsedit.component.css']
})


export class MerchantproductseditComponent implements OnInit{
  docTopimage: any;
  file0:any;
  ...
  constructor(logService : LogService ,headerFooterService :HeaderfooterService, imgConfigService: ImgconfigService,formBuilder:FormBuilder,apiService:ApiService, router :Router, route:ActivatedRoute, http:HttpClient){
    ...
    this.Merchantusers = JSON.parse(this.mdata);
      ...
      {
          if(this.Merchantusers.roleid === "03" && this.Merchantusers.firstName.length > 0 )
          {
              //alert(" valid Vendor ")
          }
          else{
    ...
    this.router = router;
     ...
     this.productsForm = this.formBuilder.group({
        ...
        roleid:[this.Merchantusers.roleid ],
        merchantid:[this.Merchantusers.id],
        merchantmobile:[this.Merchantusers.mobile]
      ...
      this.apiService.getproductbyid(params.id).subscribe(
        ...
        this.logService.clog(this.productdata,false);
             ...
             this.readFile(this.imgConfig+"/"+this.productdata.topimage,0);
                  ...
                  // alert(this.productdata.topimage);
             ...
             this.productsForm = this.formBuilder.group({
              ...
              vendorname:[this.productdata.vendorname],
       ...
       this.apiService.getAllSize().subscribe(
        (response: any) => {
          ...
          this.logService.clog(" Size ",this.sizes,false);
...
onSubmit()
{
    ...
    this.apiService.updateproductbyid(this.formData).subscribe(
      (response : any) => {
            ...
            if(response.mesage == "Data Stored successfully." || response.status == 200)
            {
                ...
                this.router.navigateByUrl('/merchantproducts.component');
            }
      })
}
