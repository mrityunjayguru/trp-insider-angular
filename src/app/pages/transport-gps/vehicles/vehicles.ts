...
export class Vehicles implements AfterViewInit {
  ...
  constructor(formBuilder: FormBuilder, apiService: ApiService) {
    ...
    this.formsize = this.formBuilder.group({
      ...
      vehicletypemakerorbrand: ['', Validators.required],
      vehicletypemakerorbrandid: ['', Validators.required],
      vehicletyperegname: ['', Validators.required],
      fuletypename: ['', Validators.required],
      fuletypeid: ['', Validators.required],

      gpsdevicename: ['', Validators.required],
      gpsdeviceid: [''], // Currently not bound in HTML or used in manual check

      ownedbyname: ['', Validators.required],
      ownedbyid: [''],
    });
