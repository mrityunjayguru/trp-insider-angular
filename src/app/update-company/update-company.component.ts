  ...
  this.logService = logService;
    ...
    this.router = router;
     ...
     .subscribe((params:any) => {
      ...
      this.apiService.getcompanybyid(params.id).subscribe(
        (response : any) => {
        ...
        console.log(" this.productdata ");
             ...
             this.productsForm = this.formBuilder.group({
              ...
              companyType:[this.productdata.companyType],
              gstNumber:[this.productdata.gstNumber],
              emailId:[this.productdata.emailId],
              mobileNumber:[this.productdata.mobileNumber],
              companyCountry:[this.productdata.companyCountry],
              companyState:[this.productdata.companyState],
              companyCity:[this.productdata.companyCity],
              companyPincode:[this.productdata.companyPincode],
              companyIdNumber:[this.productdata.companyIdNumber],
