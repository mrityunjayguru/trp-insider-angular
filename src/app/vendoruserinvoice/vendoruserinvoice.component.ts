...
@Component({
  selector: 'app-vendoruserinvoice',
  templateUrl: './vendoruserinvoice.component.html',
  styleUrls: ['./vendoruserinvoice.component.css']
})

export class VendoruserinvoiceComponent implements OnInit {
  apiService: any;
