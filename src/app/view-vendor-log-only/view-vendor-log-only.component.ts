...
@Component({
  selector: 'app-view-vendor-log-only',
  templateUrl: './view-vendor-log-only.component.html',
  styleUrls: ['./view-vendor-log-only.component.css']
})
export class ViewVendorLogOnlyComponent {
